...
<html lang="en">
  ...
  <head>
    ...
    <title>HEALTHRE ~ Reset Password</title>
...
<body>
  ...
  <header class="main-header clearfix" role="header">
    <div class="logo">
      <a href="index.html"><em>HEALTH</em>RE</a>
    </div>
       ...
       <div class="col-md-6">
          ...
          <div class="continer centerIt">
            <div style="color: white;">
              ...
              <br>
              <br>
              <p>Email #1 - <a href="mailto:victor.njaramba@strathmore.edu">victor.njaramba@strathmore.edu</a></p>
              
              <p>Phone - +254 704 062425</p>
            </div>
          </div>
        </div> 
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <p><i class="fa fa-copyright"></i> Copyright 2022   
           ...
           | Design by: Victor Njaramba (145519) </p>
        </div>
      </div>
    </div>
  </footer>
